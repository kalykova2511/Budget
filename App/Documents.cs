...
namespace DGVPrinterHelper //AllocationRequest
{
    ...
    public static class Extensions
    {
            ...
            Graphics g, int pagewidth, int pageheight, Margins margins)
        {
            foreach (T t in list)
            {
                if (t is Documents.ImbeddedImage)
                {
                    Documents.ImbeddedImage ii = (Documents.ImbeddedImage)Convert.ChangeType(t, typeof(Documents.ImbeddedImage));
