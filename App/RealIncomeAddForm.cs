...
{
    public partial class RealIncomeAddForm : Form
    {
        MainForm f;
        public RealIncomeAddForm(MainForm f)
        {
            InitializeComponent();
            this.f = f;
            FillCB();
        ...
        {
            CategoryAddForm form = new CategoryAddForm(5, f, this);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (var co = new MySqlConnection("server=christlh.beget.tech;port=3306;database=christlh_fin_sys;user=christlh_fin_sys;password=OisbkfA5oMaX;"))
            {
                MySqlCommand insert = new MySqlCommand("INSERT INTO real_incomes(bill, date, category_id) " +
