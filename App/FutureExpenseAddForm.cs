...
{
    public partial class FutureExpenseAddForm : Form
    {
        MainForm f;
        public FutureExpenseAddForm(MainForm f)
        {
            InitializeComponent();
            this.f = f;
            FillCB();
        ...
        {
            CategoryAddForm form = new CategoryAddForm(4, f, this);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (var co = new MySqlConnection("server=christlh.beget.tech;port=3306;database=christlh_fin_sys;user=christlh_fin_sys;password=OisbkfA5oMaX;"))
            {
                MySqlCommand insert = new MySqlCommand("INSERT INTO future_expenses(bill, start_date, end_date, category_id) " +
